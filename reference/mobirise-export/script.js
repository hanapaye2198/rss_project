...
(function() {
    ...
    l(function() {
            ...
            b(a, "[data-bg-video]").forEach(function(a) {
                ...
                if (b) {
                    ...
                    if (c && (/youtu\.?be/g.test(c[3]) || /vimeo/g.test(c[3])))
                            ...
                            d.onload = function() {
                                if (120 === (d.naturalWidth || d.width)) {
                                    ...
                                    case "sddefault.jpg":
                                        ...
                                        break;
                                    default:
                                        p && (e.style.backgroundImage = 'url("images/no-video.jpg")',
                        ...
                        p && (e.style.backgroundImage = 'url("images/video-placeholder.jpg")',
                        e.style.display = "block")
                }
            })
        }
        ...
        window.addEventListener("scroll", function() {
            ...
            if (m) {
                ...
                b ? c != m.fixed && (n ? (m.fixed = c,
                m.elm.classList.toggle("is-fixed")) : f = setTimeout(function() {
                    m.fixed = c;
                    m.elm.classList.toggle("is-fixed")
                }, 40)) : (m.fixed = !1,
                m.elm.classList.remove("is-fixed"))
            }
        });
        if (t)
    ...
    if (!p) {
        ...
        !v() && (u = document.querySelector("section.menu")) && (z = window.innerWidth,
    ...
    p || ("undefined" === typeof window.initClientPlugin && 0 != document.body.querySelectorAll(".clients").length && (window.initClientPlugin = !0,
