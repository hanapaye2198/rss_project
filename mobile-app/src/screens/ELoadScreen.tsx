...
const styles = StyleSheet.create({
  ...
  network: { position: 'relative', width: '31.4%', minHeight: 98, marginBottom: 11, borderWidth: 1, borderColor: colors.line, borderRadius: 14, backgroundColor: colors.white, alignItems: 'center', justifyContent: 'center', gap: 9, padding: 8 },
