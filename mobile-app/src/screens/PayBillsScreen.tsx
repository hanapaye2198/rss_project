...
const styles = StyleSheet.create({
  ...
  category: { position: 'relative', width: '31.4%', minHeight: 94, borderWidth: 1, borderColor: colors.line, borderRadius: 14, backgroundColor: colors.white, alignItems: 'center', justifyContent: 'center', gap: 8, padding: 8 },
