  ...
  return (
    <Screen backgroundColor={colors.blue} contentStyle={styles.screenContent} scroll>
      ...
      <View style={styles.content}>
        <View style={styles.balanceCard}><View><Text style={styles.mutedLight}>Total saved</Text><Text style={styles.balance}>PHP 30,700.00</Text><Text style={styles.earned}>+PHP 214.90 interest earned</Text></View><View style={styles.saveIcon}><Ionicons name="save-outline" size={25} color={colors.white} /></View></View>
